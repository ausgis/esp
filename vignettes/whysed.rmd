...
mc_simq = \(cores = 6){
  ...
  calcul_q = \(paramgd) {
    ...
    sed = hclustgeo_disc(y,alpha = rhov)
...
##     <dbl>  <dbl>     <dbl> <dbl>
##  1  0.901  0.875  0.0259    0.05
##  2  0.912  0.913 -0.000710  0.05
##  3  0.889  0.906 -0.0168    0.05
##  4  0.865  0.879 -0.0141    0.05
##  5  0.899  0.911 -0.0127    0.05
##  6  0.864  0.900 -0.0366    0.05
##  7  0.888  0.902 -0.0136    0.05
##  8  0.866  0.888 -0.0226    0.05
##  9  0.886  0.904 -0.0185    0.05
## 10  0.892  0.897 -0.00425   0.05
## # ℹ 18,990 more rows
tapply(qv$qv_bias, qv$rho, mean)
##         0.05          0.1         0.15          0.2         0.25          0.3         0.35 
## -0.008037905 -0.020124687 -0.029447634 -0.037872126 -0.043468171 -0.051037123 -0.061271964 
##          0.4         0.45          0.5         0.55          0.6         0.65          0.7 
## -0.072263793 -0.080236929 -0.088409499 -0.101410817 -0.111902646 -0.124996450 -0.140628030 
##         0.75          0.8         0.85          0.9         0.95 
## -0.166978785 -0.219878847 -0.281338326 -0.332704575 -0.336235464
```
