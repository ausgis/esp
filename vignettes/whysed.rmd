...
mc_simq = \(cores = 6){
  ...
  paradf = tidyr::crossing("lambda" = lambda,
                           "ui" = 1:1000)
  ...
  calcul_q = \(paramgd){
    lambdav = paramgd[[1]]
    u_i = paramgd[[2]]
    y = spdgp::sim_slx_error(us[[u_i]], simx$simx_strata, simx$simx_strata*2,
                             lw, lambda = lambdav)
  ...
  if (doclust) {
    parallel::clusterExport(cores, varlist = c("simx","us","lambda","lw"))
...
## -0.0025354649 -0.0019382277 -0.0017470161 -0.0017647568 -0.0009594560 -0.0009619311 -0.0014676121 
##           0.4          0.45           0.5          0.55           0.6          0.65           0.7 
## -0.0021630164 -0.0015483932 -0.0028933379 -0.0028576090 -0.0024635631 -0.0017643582 -0.0028554668 
##          0.75           0.8          0.85           0.9          0.95 
## -0.0038794885 -0.0044415341 -0.0070762746 -0.0071110826 -0.0118251243
```
