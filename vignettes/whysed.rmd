...
mc_simq = \(cores = 6){
  ...
  calcul_q = \(paramgd){
    lambdav = paramgd[[1]]
    u_i = paramgd[[2]]
    y = spdgp::sim_durbin(us[[u_i]], simx$simx_strata, simx$simx_strata*2, lw, lambda = lambdav)
...
qv = mc_simq(cores = 12)
## Error in checkForRemoteErrors(val): 12 nodes produced errors; first error: unused argument (lambda = lambdav)
qv
