...
mc_simq = \(cores = 6){
  ...
  calcul_q = \(paramgd){
    ...
    qv = sesp::sesp(y~.,data = dt,listw = lw,discvar = "xv",discnum = 3,
...
qv = mc_simq(cores = 12)
## Error in checkForRemoteErrors(val): 12 nodes produced errors; first error: no applicable method for 'st_geometry' applied to an object of class "c('tbl_df', 'tbl', 'data.frame')"
```
