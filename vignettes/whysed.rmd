...
```{r plot_mcres,fig.width=4.05,fig.height=2.85,fig.cap=knitr::asis_output("**Figure 1**. The results of Q-values from 1000 explicit spatial discretization simulations.")}
