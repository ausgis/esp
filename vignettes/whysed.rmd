...
mc_simq = \(cores = 6){
  ...
  calcul_q = \(paramgd){
    rhov = paramgd[[1]]
    u_i = paramgd[[2]]
    y = spdgp::sim_durbin(us[[u_i]], simx$simx_strata, simx$simx_strata*2, lw, rho = rhov)
...
##     <dbl>  <dbl>   <dbl> <dbl>
##  1  0.997  0.997  0       0.05
##  2  0.997  0.997  0       0.05
##  3  0.998  0.998  0       0.05
##  4  0.998  0.998  0       0.05
##  5  0.998  0.998  0       0.05
##  6  0.998  0.998  0       0.05
##  7  0.998  0.998  0       0.05
##  8  0.997  0.997  0       0.05
##  9  0.997  0.997  0       0.05
## 10  0.916  0.998 -0.0816  0.05
## # ℹ 18,990 more rows
tapply(qv$qv_bias, qv$rho, mean)
##         0.05          0.1         0.15          0.2         0.25          0.3         0.35 
## -0.002627495 -0.003894198 -0.006813370 -0.015434326 -0.020038122 -0.030602082 -0.040933804 
##          0.4         0.45          0.5         0.55          0.6         0.65          0.7 
## -0.044267231 -0.040083414 -0.036582043 -0.049289301 -0.066918405 -0.088894755 -0.097398026 
##         0.75          0.8         0.85          0.9         0.95 
## -0.112838765 -0.125296388 -0.169988507 -0.221233730 -0.238267946
```
