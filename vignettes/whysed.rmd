...
mc_simq = \(times = 1000, cores = 6){
  ...
  calcul_q = \(n_sim) {
    ...
    x_sid = gdverse::robust_disc(y ~ .,
                                 data = tibble::tibble(y = y,x = x_sim),
                                 discnum = 5, cores = 1) |>
      dplyr::pull(1) |>
      as.factor() |>
      as.integer()
    qv1 = gdverse::factor_detector(y,x_sed)[[1]]
    qv2 = gdverse::factor_detector(y,x_sid)[[1]]
    res = tibble::tibble(qv_sed = qv1, qv_sid = qv2,
                         moran = moran, moran_p = moran_p)
    return(res)
  }
...
qv
## # A tibble: 1,000 × 4
##    qv_sed qv_sid    moran moran_p
##     <dbl>  <dbl>    <dbl>   <dbl>
##  1  0.198 0.0321 -0.0213   0.873 
##  2  0.190 0.0258 -0.0248   0.909 
##  3  0.204 0.0226  0.0273   0.0570
##  4  0.140 0.0282 -0.0264   0.923 
##  5  0.176 0.0261 -0.0169   0.814 
##  6  0.172 0.0249 -0.00730  0.639 
##  7  0.206 0.0267  0.00347  0.403 
##  8  0.198 0.0249  0.0239   0.0820
##  9  0.191 0.0306  0.00552  0.359 
## 10  0.208 0.0316  0.0272   0.0578
## # ℹ 990 more rows
```
...
##    qv_sed qv_sid  moran  moran_p
##     <dbl>  <dbl>  <dbl>    <dbl>
##  1  0.204 0.0335 0.0292 0.0461  
##  2  0.192 0.0273 0.0341 0.0249  
##  3  0.201 0.0251 0.0402 0.0106  
##  4  0.197 0.0225 0.0557 0.000762
##  5  0.201 0.0324 0.0308 0.0377  
##  6  0.196 0.0325 0.0552 0.000843
##  7  0.173 0.0198 0.0313 0.0357  
##  8  0.176 0.0302 0.0365 0.0181  
##  9  0.172 0.0322 0.0336 0.0266  
## 10  0.180 0.0287 0.0419 0.00822 
## # ℹ 44 more rows
```
