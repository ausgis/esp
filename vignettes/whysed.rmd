...
```{r real_stratification_x,fig.width=3.2,fig.height=2.7,fig.cap=knitr::asis_output("**Figure 1**. Strata of simulated independent variable X")}
...
```{r sim_x,fig.width=3.2,fig.height=2.7,fig.cap=knitr::asis_output("**Figure 2**. Simulated independent variable X")}
