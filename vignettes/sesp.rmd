...
![**Figure 2**. Optimal spatial discretization result with linear regression operator](../man/figures/sesp/optdisc1-1.png)
...
![**Figure 3**. Optimal spatial discretization result with spatial lag regression operator](../man/figures/sesp/optdisc2-1.png)
...
![**Figure 4**. Optimal spatial discretization result with spatial error regression operator](../man/figures/sesp/optdisc3-1.png)
...
![**Figure 5**. Optimal spatial discretization result with spatial durbin regression operator](../man/figures/sesp/optdisc4-1.png)
...
![**Figure 6**. Optimal spatial discretization result with geographically weighted regression operator](../man/figures/sesp/optdisc5-1.png)
