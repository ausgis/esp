...
## Error in checkForRemoteErrors(val): 6 nodes produced errors; first error: ℹ In index: 1.
## ℹ With name: x1.
## Caused by error in `predict.Sarlm()`:
## ! no such predict method for error model
## Timing stopped at: 4.31 0.61 24.1
g3
